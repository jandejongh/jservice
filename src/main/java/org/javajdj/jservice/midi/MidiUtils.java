...
public class MidiUtils
{
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //
  // MIDI MESSAGE [PART] ACQUISITION
  //
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

  /** Ensures that all bytes in given byte array are MIDI Data Bytes.
   * 
   * @param bytes The bytes, non-{@code null}.
   * 
   * @return The argument if all bytes are MIDI Data Bytes (in Java terms, are zero or positive).
   * 
   * @throws IllegalArgumentException If the argument is {@code null} or contains at least one MIDI Control Byte.
   * 
   */
  public static byte[] ensureAllMidiDataBytes (final byte[] bytes)
  {
    if (bytes == null)
      throw new IllegalArgumentException ();
